...
Public Class CrystalReportCNL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrystalReportCNL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportCNL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportCNL = New CrystalReportCNL()
        rpt.Site = Me.Site
        Return rpt
    End Function
