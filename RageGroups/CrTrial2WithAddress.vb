...
Public Class CrTrial2WithAddress
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrTrial2WithAddress.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrTrial2WithAddress.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTrial2WithAddress
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTrial2WithAddress = New CrTrial2WithAddress()
        rpt.Site = Me.Site
        Return rpt
    End Function
