...
Public Class CrCashReceived
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrCashReceived.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrCashReceived
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCashReceived = New CrCashReceived()
        rpt.Site = Me.Site
        Return rpt
    End Function
