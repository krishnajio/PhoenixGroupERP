...
Public Class frmTrialWSOS
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        If chkadvformat.Checked = True Then
            ...
            r.SetParameterValue("s1", "Trial Balance as on " & dtfrom.Text)
    ...
    Public Sub AllGroup()
        If rdwithopening.Checked = True Then
           ...
           & " isnull(opening_cr,0) ocr from " & GMod.ACC_HEAD & " where group_name not in ('CASH IN HAND','STAFF')   ) q " _
        ...
        If edwoopening.Checked = True Then
            SqlSelect1 = "select q.account_code,q.acname," _
                    ...
                    & " on p.acc_head_code=q.account_code  " _
                    & " where ((isnull(p.dramt,0) + q.odr) <> (isnull(p.cramt,0) + q.ocr)) and q.group_name not in ('CASH IN HAND','STAFF') "
        End If
    ...
    Public Sub GroupWise()
        ...
        If rdwithopening.Checked = True Then
           ...
           & " Right Join " _
           & " ( select account_code,account_head_name acname ,group_name, isnull(opening_dr,0) odr  , " _
           & " isnull(opening_cr,0) ocr from " & GMod.ACC_HEAD & " where group_name='" & cmbgrpname.Text & "'  and right(account_head_name,4)='" & wsos & "' ) q " _
           & " on p.acc_head_code=q.account_code  " _
           & " where ((isnull(p.dramt,0) + q.odr) <> (isnull(p.cramt,0) + q.ocr))  "
        End If
    ...
    End Sub
    Dim wsos As String
    Private Sub rdWs_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdWs.CheckedChanged
        If rdWs.Checked = True Then
            wsos = "(WS)"
        End If
    End Sub

    Private Sub rdOS_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdOS.CheckedChanged
