...
Public Class CrHatchDetialReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrHatchDetialReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrHatchDetialReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_s() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrHatchDetialReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrHatchDetialReport = New CrHatchDetialReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
