...
Public Class CrAduitStcok
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrAduitStcok.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrAduitStcok
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrAduitStcok = New CrAduitStcok()
        rpt.Site = Me.Site
        Return rpt
    End Function
