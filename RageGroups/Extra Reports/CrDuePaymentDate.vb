...
Public Class CrDuePaymentDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrDuePaymentDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDuePaymentDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDuePaymentDate = New CrDuePaymentDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
