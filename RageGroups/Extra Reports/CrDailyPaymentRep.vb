...
Public Class CrDailyPaymentRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrDailyPaymentRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDailyPaymentRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDailyPaymentRep = New CrDailyPaymentRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
