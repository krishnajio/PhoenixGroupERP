...
Public Class CrNewTrialBetDays
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrNewTrialBetDays.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrNewTrialBetDays
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrNewTrialBetDays = New CrNewTrialBetDays()
        rpt.Site = Me.Site
        Return rpt
    End Function
