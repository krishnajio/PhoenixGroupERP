...
Public Class CrMobileList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrMobileList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrMobileList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrMobileList = New CrMobileList()
        rpt.Site = Me.Site
        Return rpt
    End Function
