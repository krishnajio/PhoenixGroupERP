...
Public Class CrMortalityRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrMortalityRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrMortalityRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrMortalityRep = New CrMortalityRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
