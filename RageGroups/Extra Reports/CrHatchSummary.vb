...
Public Class CrHatchSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrHatchSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrHatchSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrHatchSummary = New CrHatchSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
