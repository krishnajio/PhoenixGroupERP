...
Public Class CrCustDrCrCashrecsaletoCustSaletoIP
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrCustDrCrCashrecsaletoCustSaletoIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrCustDrCrCashrecsaletoCustSaletoIP.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_0() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrCustDrCrCashrecsaletoCustSaletoIP
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrCustDrCrCashrecsaletoCustSaletoIP = New CrCustDrCrCashrecsaletoCustSaletoIP()
        rpt.Site = Me.Site
        Return rpt
    End Function
