...
Public Class frmGSTTDS
    ...
    Private Sub frmPurchasePoultrty_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GMod.DataSetRet("select vtype from vtype where cmp_id='" & GMod.Cmpid & "' and vtype like '%TDS PUR JOURNL(GST)%'  and session = '" & GMod.Session & "'", "vt")
    ...
    Private Sub dgvoucher_RowEnter(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvoucher.RowEnter
        ...
        'sumdrcr()
    End Sub
    Dim totgridamount, gst, sgst, igst, tds As Double
    Sub gridtotal()
        totgridamount = 0
        gst = 0
        sgst = 0
    ...
    Private Sub txtTDSamt_TextChanged(sender As Object, e As EventArgs) Handles txtTDSamt.TextChanged
        If chgFlag = False Then
            gridtotal()
            txtTotal.Text = -Val(txtFreight.Text) - Val(txtTDSamt.Text) + totgridamount + gst + igst
        End If
    End Sub
