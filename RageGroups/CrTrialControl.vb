...
Public Class CrTrialControl
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrTrialControl.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTrialControl
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTrialControl = New CrTrialControl()
        rpt.Site = Me.Site
        Return rpt
    End Function
