Public Class frmsubgroup
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        Sqlsavestr = "Insert into Sub_Group(Sub_group_name, Group_name,Shedules,Cmp_id,session, Suffix) values ("
    ...
    Private Sub fillcomboGroups()
        ...
        sqlselectroup = "select Group_name,Suffix from Groups where Cmp_id='" & GMod.Cmpid & "' and session ='" & GMod.Session & "'"
        GMod.DataSetRet(sqlselectroup, "Gropu_name")

        cmbgroup.DataSource = GMod.ds.Tables("Gropu_name")
        cmbgroup.DisplayMember = "Group_name"

        cmbgrpsuffix.DataSource = GMod.ds.Tables("Gropu_name")
        cmbgrpsuffix.DisplayMember = "Suffix"
    End Sub
    ...
    Public Sub fillgrid()
        ...
        sqlselectall = "select Sub_group_name, Group_name,  Shedules,Suffix from Sub_Group where Cmp_id='" & GMod.Cmpid & "'  and session ='" & GMod.Session & "'"
    ...
    Private Sub txtsubgroupname_Leave(sender As Object, e As EventArgs) Handles txtsubgroupname.Leave
        If txtsubgroupname.Text.Length > 0 Then
            txtgroupsfx.Text = txtsubgroupname.Text.Substring(0, 2).ToUpper
            txtsubgroupname.Text = txtsubgroupname.Text.ToUpper
            gprefix = txtsubgroupname.Text.Substring(0, 2).ToUpper
        End If
    End Sub
    Private Sub txtgroupsfx_Leave(sender As Object, e As EventArgs) Handles txtgroupsfx.Leave
        txtprefix.Text = cmbgrpsuffix.Text + txtgroupsfx.Text
    End Sub
    Private Sub cmbgrpsuffix_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbgrpsuffix.SelectedIndexChanged
        txtprefix.Text = cmbgrpsuffix.Text + txtgroupsfx.Text
    End Sub
End Class