Public Class frmvtype
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        Sqlsavestr = "Insert into Vtype(Cmp_id, Vtype, Seqorder,Vou_no_seq,vprefix,session) values ("
    ...
    Public Sub fillgrid()
        ...
        If txtvtype.Text = "" Then
            sqlselectall = "select Vtype, Seqorder,Vou_no_seq,vprefix from Vtype where Cmp_id='" & GMod.Cmpid & "' and session ='" & GMod.Session & "'"
        Else
            sqlselectall = "select Vtype, Seqorder,Vou_no_seq,vprefix from Vtype where Cmp_id='" & GMod.Cmpid & "' and vtype like '%" & txtvtype.Text & "%' and session ='" & GMod.Session & "'"
        End If
