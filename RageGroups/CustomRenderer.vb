...
Public Class CustomRenderer
    ...
    Protected Overrides Sub OnRenderItemText(ByVal e As ToolStripItemTextRenderEventArgs)
        If GMod.PerviousSession = True Then
            ...
            e.TextFont = New Drawing.Font("Trebuchet MS", 9, FontStyle.Bold)
        Else
    ...
    Protected Overrides Sub OnRenderImageMargin(ByVal e As ToolStripRenderEventArgs)
        ...
        Dim b As New LinearGradientBrush(e.AffectedBounds, Color.Chocolate, Color.Honeydew, 0)
        Using b
    ...
    Protected Overrides Sub OnRenderMenuItemBackground(ByVal e As ToolStripItemRenderEventArgs)
        ...
        If e.Item.Selected Or e.Item.Pressed Then
            ...
            Dim b As New LinearGradientBrush(New Rectangle(0, 0, e.Item.Bounds.Width, e.Item.Bounds.Height), Color.WhiteSmoke, Color.SteelBlue, 90)
            Using b
    ...
    Protected Overrides Sub OnRenderToolStripBackground(ByVal e As ToolStripRenderEventArgs)
        Dim g As Graphics = e.Graphics
        Dim b As New LinearGradientBrush(e.AffectedBounds, Color.DarkGray, Color.Teal, 90)
        g.FillRectangle(b, e.AffectedBounds)
        b.Dispose()
