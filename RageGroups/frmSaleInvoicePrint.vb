    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        Try
            ...
            sql2 = "select BillDate,AccCode,address,Area_code,Areaname,city,h.state " _
                    ...
                    & " WHERE vou_type='" & voutype.Text & "' and  cast(vou_no as bigint)  between '" & txtCrNoFrom.Text & "' and '" & txtCrNoTo.Text & "'  and (ProductName='BROILER CHICKS' OR ProductName='COCKREL CHICKS'  OR ProductName='LAYER CHICKS' or ProductName='BROILER HATCHING EGGS' OR ProductName='INVOICE CANCELLED' or ProductName='LAYER HATCHING EGGS') AND p.CMP_ID='" & Cmpid & "' AND SESSION = '" & GMod.Session & "' and authr<>'-' order by cast(BillNo as bigint)"
            ...
            & " from Printdata WHERE  vou_type='" & voutype.Text & "' and cast(vou_no as bigint)  between '" & txtCrNoFrom.Text & "' and '" & txtCrNoTo.Text & "'  and (ProductName='BROILER CHICKS' OR ProductName='COCKREL CHICKS' OR ProductName='LAYER CHICKS' or  ProductName='BROILER HATCHING EGGS' OR ProductName='INVOICE CANCELLED' or ProductName='LAYER HATCHING EGGS') AND CMP_ID='" & Cmpid & "' AND SESSION = '" & GMod.Session & "' and authr<>'-' order by cast(BillNo as bigint)"
