...
Public Class frmPurchasePoultrty_NewGst
    ...
    Private Sub dtVdate_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtVdate.Leave
        If btnsave.Enabled = True Then
            ...
            If dtVdate.Value < CDate(GMod.ds.Tables("getMaxDate").Rows(0)(0).ToString) Then
                MessageBox.Show("Selected Date is Less Than Prevois Entred Voucher date", "Date Error", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                dtVdate.Focus()
            End If
        End If
    End Sub
        ...
        Try
            If btn_modify.Text = "&Modify" Then
                ...
                If vou <> "" And vt <> "" Then
                    ...
                    ' dtVdate.MinDate = CDate(GMod.SessionCurrentDate).AddDays(-Val(GMod.nofd))
                    dtVdate.Value = CDate(GMod.ds.Tables("pur_modify").Rows(0)("vou_date"))
    ...
    Public Function checkBill()
        Dim ch As String
        ch = "select bill_no from purchase_data where session ='" & GMod.Session & "' and party_code='" & cmbacheadcode.Text & "' and bill_no='" & txtBillNo.Text & "'" ' and authr <>'-'"
    ...
    Private Sub voutype_Leave(sender As Object, e As EventArgs) Handles voutype.Leave
        checkBill()
    End Sub
    ...
    Private Sub btnDebitNote_Click(sender As Object, e As EventArgs) Handles btnDebitNote.Click
        ...
        party_name = cmbacheadname.Text
        Billdate = dtbilldate.Value
        Dim frmDebitnote As New frmDrNote
        frmDebitnote.Show()
        cmbPrduct.Focus()
    End Sub
    ...
    Private Sub dtppodate_Leave(sender As Object, e As EventArgs) Handles dtppodate.Leave
        checkBill()
    End Sub

    Private Sub txtImwno_Leave(sender As Object, e As EventArgs) Handles txtImwno.Leave
        checkBill()
    End Sub
