...
Public Class frmSalesRegisterChicksAuthrization
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        Try
            ...
            sql2 = "select [invno], [invdate], [hdate], [code], [cname], [qty], [free], [invamt], tds_amt  as [tcs_per] , neccamt, [pheadname], [prd_name], [rate], [area], [uanme], [vou_type], [prdunit], [Mortality], [gstin], [tcs_per], [tcs_amt] from salereg  where vou_type='" & voutype.Text & "' and uanme='" & GMod.username & "' order by id  "
