...
Public Class CrTrial2_Unauth
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrTrial2_Unauth.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTrial2_Unauth
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTrial2_Unauth = New CrTrial2_Unauth()
        rpt.Site = Me.Site
        Return rpt
    End Function
