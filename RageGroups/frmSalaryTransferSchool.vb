...
Public Class frmSalaryTransferSchool
    ...
    Private Sub frmSalaryTransfer_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim ConStrSal As String = "Data Source=phxserver;Initial Catalog=LWS_salary_new;User ID=sa;Password=p#hoenix@g"
        Dim da1 As New SqlDataAdapter("select distinct OrganizationName from  vwslip", ConStrSal)
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        ElseIf GMod.Cmpid = "LWSS" Then
            ...
            orgid = "Org001"
            sql = "select * from DepartmentMaster where Orgid='" & orgid & "' order by Department"
        ...
        For i = 0 To dsSal.Tables("Department").Rows.Count - 1
            ...
            End Try
            'If GMod.Cmpid = "PHOE" Then
            sql = "select sum(amtpay+hra+cca+oa2+da) from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "'"
            da = New SqlDataAdapter(sql, ConStrSal)
        ...
        If GMod.Cmpid = "PHOE" Then
            Try
                ...
                sql = "select empid,secudep from salacctransfer where secudep>0 and orgid='Hatcheries Casual Staff' and salmonth='" & dtSalaryDate.Value.ToShortDateString & "' "
                da = New SqlDataAdapter(sql, ConStrSal)
