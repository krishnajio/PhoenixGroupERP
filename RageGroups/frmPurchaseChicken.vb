...
Public Class frmPurchaseChicken
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        narration = "BILL NO " & txtInvnoNo.Text & " DT." & dtInvVate.Text & " DM NO " & lblbatchno.Text & " "
        Try
            For i = 0 To dgPurchase.Rows.Count - 1
                'narration = " "
        ...
        Try
            ...
            If btnSave.Enabled = True Then
                ...
                If vou_no <> "" Then
                    ...
                    sql = "select * from " & GMod.VENTRY & " where Vou_no='" & vou_no & "' and vou_type='" & cmbvtype.Text & "' and   group_name in ('FREIGHT','EXPENSES','FREIGHT')"
            ...
            Else
                ...
                sqldel = "delete from " & GMod.VENTRY & " where vou_no='" & txtVoucherNo.Text & "' and vou_type='" & cmbvtype.Text & "'"
                GMod.SqlExecuteNonQuery(sqldel)

                sqldel1 = "delete from InvPhxChicken where vou_no='" & txtVoucherNo.Text & "' and vou_type='" & cmbvtype.Text & "' and Session ='" & GMod.Session & "'"
