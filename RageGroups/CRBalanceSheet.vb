...
Public Class CRBalanceSheet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CRBalanceSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRBalanceSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRBalanceSheet = New CRBalanceSheet()
        rpt.Site = Me.Site
        Return rpt
    End Function
