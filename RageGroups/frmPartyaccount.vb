...
Public Class frmPartyaccount
        ...
        Try
            ...
            If GMod.ds.Tables("tableaccount").Rows.Count <> 0 Then
                ...
                Else
                    ...
                    sql += "account_type,opening_dr,opening_cr,credit_days,credit_limit,address,city,state,phone,pan_no,rate_of_interest,interest_rule_id,remark1,remark2,Area_code,remark3) "
                    sql += " values('" & GMod.Cmpid & "','" & lblacheadcode.Text & "',"
                    sql += "'" & txtacheadname.Text.ToUpper & "','" & lblgroupname.Text & "','" & cmbsubgrpname.Text & "','" & Trim(txtGstIn.Text) & "'," & dr & ","
    ...
    Private Sub btnmodify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnmodify.Click
        ...
        Try
            ...
            sql += " rate_of_interest='" & txtintrate.Text.ToString & "',interest_rule_id=" & Val(cmbintruleid.Text) & ",remark1='" & txtremark1.Text & "',remark2='" & txtremark2.Text & "', Area_code='" & cmbAreaCode.Text & "',remark3='" & txtEmailID.Text & "',"
            sql += "  account_code='" & lblacheadcode.Text & "', account_type ='" & txtGstIn.Text.Trim() & "',"
