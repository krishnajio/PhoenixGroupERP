...
Public Class frmPurchasePoultrty
    ...
    Private Sub frmPurchasePoultrty_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GMod.DataSetRet("select itemname from ItemMasterOther where prdtype =1", "puritems")
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        If MessageBox.Show("Are U Sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                For i = 0 To dgvoucher.Rows.Count - 1
                    ...
                    If Val(dgvoucher(10, i).Value) > 0 Then
                     ...
                     & "Narration, Group_name, Sub_group_name,Ch_issue_date) values ("
                        ...
                        TaxFlag = "GST"
                        TaxPer = Val(txtgstper.Text)
                        VoucherTax = "CGST"
                    End If

                    sqlsave = "insert into " & GMod.VENTRY & " (Cmp_id, Uname, Entry_id, Vou_no," _
                     & " Vou_type, Vou_date, Acc_head_code, Acc_head, dramt, cramt, Pay_mode, Cheque_no, " _
                    & "Narration, Group_name, Sub_group_name,Ch_issue_date,ch_date,VoucherTax, TaxPer, TaxType, WinOut) values ("
                    sqlsave &= "'" & GMod.Cmpid & "',"
                    sqlsave &= "'" & GMod.username & "',"
                    sqlsave &= "'-4',"
                    sqlsave &= "'" & lblvouno.Text & "',"
                    ...
                    " vathead, csthead, cst_code, cst_amt, porate,fr_head,cform,po_date, form49No, form49issue,Broker_Code,mkt_rate,gst_code, gst_per, gst_amt, poly, jute,vat_per,cst_per,itemname)  values ( "
                    ...
                    sqlsave &= "'" & Val(dgvoucher(22, i).Value) & "')"
                ...
                sqlsave &= "'" & total - Val(txtcramt.Text) & "',"
                sqlsave &= "'0',"
                sqlsave &= "'-',"
                sqlsave &= "'-',"
                sqlsave &= "'" & narration & "',"
    ...
    Private Sub txtigstper_KeyUp(sender As Object, e As KeyEventArgs)
    ...
    Private Sub txtigstper_SelectedIndexChanged(sender As Object, e As EventArgs)
