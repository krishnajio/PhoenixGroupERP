...
Public Class CRProfitloss
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CRProfitloss.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRProfitloss
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRProfitloss = New CRProfitloss()
        rpt.Site = Me.Site
        Return rpt
    End Function
