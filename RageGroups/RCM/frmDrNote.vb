...
Public Class frmDrNote
    ...
    Sub fillheads()
        ...
        GMod.DataSetRet(sql, "aclistDR")
        cmbacheadcode.DataSource = GMod.ds.Tables("aclistDR")
        cmbacheadcode.DisplayMember = "account_code"
        cmbacheadname.DataSource = GMod.ds.Tables("aclistDR")
        cmbacheadname.DisplayMember = "account_head_name"

        ComboBox1.DataSource = GMod.ds.Tables("aclistDR")
        ComboBox1.DisplayMember = "group_name"

        cmbSubGroup.DataSource = GMod.ds.Tables("aclistDR")
        ...
        GMod.DataSetRet(sql, "tbliTEMListDR")
        cmbItemHead.DataSource = GMod.ds.Tables("tbliTEMListDR")
        cmbItemHead.DisplayMember = "account_head_name"
        cmbItemCode.DataSource = GMod.ds.Tables("tbliTEMListDR")
    ...
    Private Sub frmDrNote_Activated(sender As Object, e As EventArgs) Handles Me.Activated
    ...
    Private Sub frmPurchasePoultrty_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GMod.DataSetRet("select prdunit from prdunit where cmp_id='" & GMod.Cmpid & "'", "prdunitDR")
        cmbPrdUnit.DataSource = GMod.ds.Tables("prdunitDR")
        cmbPrdUnit.DisplayMember = "prdunit"


        GMod.DataSetRet("select vtype from vtype where cmp_id='" & GMod.Cmpid & "' AND VTYPE LIKE '%dr note%'  and vou_no_seq='" & GMod.Dept & "' and session ='" & GMod.Session & "'", "vtDR")
        voutype.DataSource = GMod.ds.Tables("vtDR")
        ...
        If BillNo <> "" Then
            ...
            dtbilldate.Value = GMod.Billdate
            cmbacheadname.Text = party_name
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        If MessageBox.Show("Are U Sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            narration = txtnarration.Text + "#" + cmbPrduct.Text + "#" + cmbWiOs.Text
            Try
                If btnsave.Enabled = False Then
                ...
                For i = 0 To dgvoucher.Rows.Count - 1
                  ...
                  & "Narration, Group_name, Sub_group_name,Ch_issue_date,ch_date,item_name) values ("
                    ...
                    If Val(dgvoucher(10, i).Value) > 0 Then
                        ...
                        sqlsave = " insert into " & GMod.VENTRY & "(Cmp_id, Uname, Entry_id, Vou_no," _
                     & " Vou_type, Vou_date, Acc_head_code, Acc_head, dramt, cramt, Pay_mode, Cheque_no, " _
                     & "Narration, Group_name, Sub_group_name,Ch_issue_date,VoucherTax, TaxPer, TaxType) values ("
                        sqlsave &= "'" & GMod.Cmpid & "',"
                        sqlsave &= "'" & GMod.username & "',"
                        sqlsave &= "'-3',"
                        sqlsave &= "'" & lblvouno.Text & "',"
    ...
    Private Sub txtGstAmt_Leave(sender As Object, e As EventArgs) Handles txtGstAmt.Leave
        If Val(txtGstAmt.Text) > 0 Then
            ...
            cmbgstcode.Text = cmbItemCode.Text
        Else
            cmbgsthead.Text = "-"
            cmbgstcode.Text = "-"
            cmbgrpgst.Text = "-"
    ...
    Private Sub txtgstper_SelectedIndexChanged(sender As Object, e As EventArgs) Handles txtgstper.SelectedIndexChanged
    ...
    Private Sub cmbPrdType_Leave(sender As Object, e As EventArgs) Handles cmbPrdType.Leave
        GMod.DataSetRet("select itemname from ItemMasterOther where prdtype =1 and CAT='" & cmbPrdType.Text & "'", "puritemsdr")
        cmbPrduct.DataSource = GMod.ds.Tables("puritemsdr")
    ...
    Private Sub cmbPrdType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbPrdType.SelectedIndexChanged
        GMod.DataSetRet("select itemname from ItemMasterOther where prdtype =1 and CAT='" & cmbPrdType.Text & "'", "puritemsdr1")
        cmbPrduct.DataSource = GMod.ds.Tables("puritemsdr1")
        cmbPrduct.DisplayMember = "itemname"
    End Sub
End Class