...
Public Class CrFeedStockRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrFeedStockRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrFeedStockRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrFeedStockRep = New CrFeedStockRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
