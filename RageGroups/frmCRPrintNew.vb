    ...
    Public Sub btnprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnprint.Click
        ...
        Try
            ...
            For z = 0 To dgCRDebit.Rows.Count - 1
                ...
                End If
                'Voucher No 
                rec = "                                                        " & dgCRDebit(0, z).Value 'cr no
                sw.WriteLine(rec)
                sw.WriteLine("")
                sw.WriteLine("")
                'dtPrint.Value = CDate(dgCRDebit(1, z).Value.ToString)
                rec = "                                                        " & dgCRDebit(1, z).Value.ToString.ToUpper 'cr date
                sw.WriteLine(rec)
                'sw.WriteLine("")
                'sw.WriteLine("")
                'sw.WriteLine("")
            ...
            p.StartInfo.Arguments = "final.txt"
