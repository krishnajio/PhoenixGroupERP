...
Public Class frmGeneralacchead_New
    ...
    Private Sub cmbgrpname_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbgrpname.SelectedIndexChanged
        Try
            ...
            If GMod.ds.Tables("sgrp").Rows.Count > 0 Then
                ...
                cmbsubprefix.DataSource = GMod.ds.Tables("sgrp")
                cmbsubprefix.DisplayMember = "Suffix"
            Else
    ...
    Sub nxtid()
        ...
        GMod.DataSetRet("select isnull(max(right(account_code,4))+1,1) from " & GMod.ACC_HEAD & " where left(account_code,2)='" & cmbAreaCode.Text & "' and group_name='" & cmbgrpname.Text & "' and sub_group_name='" & cmbsubgrpname.Text & "'", "nxt")
        If GMod.ds.Tables("nxt").Rows.Count > 0 Then lblacheadcode.Text = cmbAreaCode.Text & cmbsubprefix.Text & Format(GMod.ds.Tables("nxt").Rows(0)(0), "0000")
        'End If
    End Sub
    Dim s, sql As String
    ...
    Private Sub cmbsubgrpname_Leave(sender As Object, e As EventArgs) Handles cmbsubgrpname.Leave
        nxtid()
    End Sub
    ...
    Private Sub cmbsubgrpname_TabIndexChanged(sender As Object, e As EventArgs) Handles cmbsubgrpname.TabIndexChanged

    End Sub

    Private Sub cmbsubprefix_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbsubprefix.SelectedIndexChanged
        nxtid()
    End Sub
End Class