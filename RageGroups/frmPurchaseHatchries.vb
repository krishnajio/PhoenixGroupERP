...
Public Class frmPurchaseHatchries
    ...
    Private Sub frmSaleInvoice_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        '    voutype.Text = "SALE"
        'Else
        GMod.DataSetRet("select * from vtype where cmp_id='" & GMod.Cmpid & "' and vtype like '%PURCHASE%' and session = '" & GMod.Session & "'", "vou_type")
        ...
        Sql = " select * from " & GMod.ACC_HEAD & " where Group_name like  '%PURCHASE%'"
        ...
        'Filling tcs tYPE 
        GMod.DataSetRet("select * from TCSMaster Where cmp_id='" & GMod.Cmpid & "' and type=0", "TCSTYPE")
    ...
    Private Sub dgSaleVoucher_CellEndEdit(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgSaleVoucher.CellEndEdit
        ...
        If e.ColumnIndex = 5 Or e.ColumnIndex = 2 Or e.ColumnIndex = 3 Then
            ...
            'MsgBox(fr)
            If GMod.Cmpid = "PHHA" Then
                qty1 = Val(dgSaleVoucher(2, dgSaleVoucher.CurrentCell.RowIndex).Value)
        ...
        End If
        Try
            'MsgBox(dgSaleVoucher(1, 0).Value)
            'CmbCrCode.SelectedText = "SALE OF " & dgSaleVoucher(1, 0).Value.ToString
            If GMod.Cmpid = "PHHA" Then
                ' CmbCrHead.SelectedIndex = CmbCrHead.FindString("SALE OF " & dgSaleVoucher(1, 0).Value)
            End If
    ...
    Private Sub dgSaleVoucher_CellEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgSaleVoucher.CellEnter
        ...
        If e.ColumnIndex = 4 Then
            If GMod.Cmpid = "PHHA" Then
                qty = Val(dgSaleVoucher(2, dgSaleVoucher.CurrentCell.RowIndex).Value)
                ...
                GMod.DataSetRet(sqlrate, "rate")
                Dim neccamt1, rate1, dis As Double
                neccamt1 = Val(GMod.ds.Tables("rate").Rows(0)(1)) * qty
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        If MessageBox.Show("Are U sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            For gloop = 0 To dgSaleVoucher.RowCount - 1
                ...
                If (Val(dgSaleVoucher(2, gloop).Value) * Val(dgSaleVoucher(3, gloop).Value)) <> Val(dgSaleVoucher(4, gloop).Value) Then
            ...
            Try
                ...
                If btnsave.Enabled = False Then
                    ...
                    sqldel = "delete from " & GMod.VENTRY & " where Vou_type='" & voutype.Text & "' and Vou_no= " & txtinvoiceno.Text
                    Dim cmddel1 As New SqlCommand(sqldel, GMod.SqlConn, sqltrans)
                    cmddel1.ExecuteNonQuery()

                    sqldel = "delete  from PrintData where  Vou_no= '" & txtinvoiceno.Text & "' and Vou_type='" & voutype.Text & "' and Cmp_id='" & GMod.Cmpid & "' and Session='" & GMod.Session & "'"
                ...
                For i = 0 To dgSaleVoucher.Rows.Count - 1
                    ...
                    qty = dgSaleVoucher(2, i).Value
                    pn = "PURCHASE OF " & dgSaleVoucher(1, i).Value.ToString
                    narration = "PURCHASE OF " & dgSaleVoucher(1, i).Value.ToString & "Hatch Date " & dtHatchdate.Text
                    narration = narration & "FROM INV NO." & lblno.Text & " DT. " & dtpInvdate.Text & " QTY " & dgSaleVoucher(2, i).Value & " + " & dgSaleVoucher(6, i).Value & "@ " & dgSaleVoucher(3, i).Value
                    nar = nar & narration
                    ...
                    If neccamt > 0 Then 'FOR NECC CONTRIBUTION
                        ...
                        neccval = Val(dgSaleVoucher(2, i).Value) * neccamt
                        'MsgBox(neccval)
                    ...
                    If neccamt > 0 Then
                        gettingNECCcodes()
                        Dim cr As Double
                        cr = Val(dgSaleVoucher(4, i).Value.ToString)
                        ...
                        ssaveprdvntry &= "'" & i + 1 & "',"
                        ssaveprdvntry &= "'" & txtinvoiceno.Text & "',"
               ...
               & " Narration, Group_name, Sub_group_name,ch_date) VALUES ("
                    ...
                    If Val(txtTDsAmt.Text) > 0 Then

                        tdsper = Val(cmbTdsper.Text)
                        tdsamt = Val(txtTDsAmt.Text)
                        ...
                        ssaveprdvntry &= "'" & Val(zero) & "',"
                        ssaveprdvntry &= "'" & Val(txtTDsAmt.Text) & "',"
                        ssaveprdvntry &= "'" & narration.ToString & "',"
                        ssaveprdvntry &= "'TCS',"
                        ssaveprdvntry &= "'" & s & "','" & dtHatchdate.Value.ToShortDateString & "')"
                        'MsgBox(ssaveprdvntry)
               ...
               & " Narration, Group_name, Sub_group_name,ch_date) VALUES ("
                    ...
                    sqlsavenecc = "insert into PrintData (Vou_type, Vou_no, AccCode, AccName, Station, ProductName," _
                                   & "Qty, Rate, Amount, DiscountRate, DiscountAmount, " _
                                   & "NeccRate, NeccAmount, FreePer, FreeQty, HatchDate," _
                                   & "BillNo, BillDate, Cmp_id, Session,type,PrdUnit,tcs_head, tcs_per, tcs_amt,tds_head, tds_per, tds_amt) VALUES ("
                    sqlsavenecc &= "'" & voutype.Text & "',"
                    sqlsavenecc &= "'" & txtinvoiceno.Text & "',"
                    sqlsavenecc &= "'" & cmbacheadcode.Text & "',"
                    sqlsavenecc &= "'" & cmbacheadname.Text & "',"
                    ...
                    sqlsavenecc &= "'" & Val(cmbTdsper.Text) & "',"
                    sqlsavenecc &= "'" & Val(txtTDsAmt.Text) & "')"
                    ...
                    productamount = productamount + Val(dgSaleVoucher(4, i).Value) + neccval
                ...
                'End If
                '-------------------------------------------
                MessageBox.Show(voutype.Text & "/" & txtinvoiceno.Text, "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Sub nxtvno()
        ...
        Try
            ...
            txtinvoiceno.Text = ds.Tables("vno8").Rows(0)(0)
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub btn_modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modify.Click
        ...
        Try
            ...
            If btn_modify.Text = "&Modify" Then
                ...
                sql = "select Acc_head from " & GMod.VENTRY & " where cramt >0 and vou_type ='" & vt & "' and vou_no='" & r & "'"
    ...
    Private Sub cmbacheadcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbacheadcode.Leave
        ...
        If btn_modify.Enabled = True Then
            sql = "select *  from tmpAging where acc_code ='" & cmbacheadcode.Text & "' and vou_type='S' and cmp_id='" & GMod.Cmpid & "'"
    ...
    Private Sub lblno_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lblno.TextChanged

    End Sub

    Private Sub dtpInvdate_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dtpInvdate.KeyUp
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
    ...
    Private Sub chkTDS_CheckedChanged(sender As Object, e As EventArgs) Handles chkTDS.CheckedChanged
        Try
            ...
            If chkTDS.Checked = True Then
                ...
                Dim tcs As Double
                'tcs = Val(dgSaleVoucher(4, 0).Value) + neccval) * ((Val(txtTcsPer.Text) / 100)
                tcs = ((Val(dgSaleVoucher(4, 0).Value) + neccval) * (Val(cmbTdsper.Text) / 100))
                tcs = Math.Ceiling(tcs)
                txtTDsAmt.Text = tcs.ToString
            Else
                txtTDsAmt.Text = 0
            End If
        Catch ex As Exception
