Imports System.IO
Public Class frmTrial2WithAddress
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        If chkadvformat.Checked = True Then
            Dim r As New CrTrial2WithAddress
        ...
        If chksimpleformat.Checked = True Then
            Dim r1 As New CrTrial2SimpleWithAddress
    ...
    Public Sub AllGroup()
        If rdwithopening.Checked = True Then
            sqlSelect = "select q.account_code,q.acname,q.address,q.pan_no,q.remark2," _
        ...
        If edwoopening.Checked = True Then
            SqlSelect1 = "select q.account_code,q.acname,q.address,q.pan_no,q.remark2," _
