...
Public Class frmAdvanceLedger
    ...
    Private Sub frmRepGeneralLedger_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        CrViewerGenralLedger.Height = Me.Height - 250
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        Try
            ...
            If RadioButton1.Checked Then
                sqlsave = "insert into repGeneralLedger1(cmpid, Acc_head_code, Narration, Vou_no, Vou_date,  vou_type, dramt, cramt, Cheque_no, Uname,VoucherTax, TaxPer, TaxType, WinOut,item_name) " _
                & " select Cmp_id,Acc_head_code,Narration,Vou_no,Vou_date,Vou_type,dramt,cramt,Cheque_no ,'" & GMod.username & "',VoucherTax, TaxPer, TaxType, WinOut,item_name from " & GMod.VENTRY _
            ...
            Else
                ...
                & " dramt, cramt, Pay_mode, Cheque_no, Narration, Group_name, Sub_group_name, Ch_issue_date, Ch_date,VoucherTax, TaxPer, TaxType, WinOut)" _
                & " select Cmp_id,'" & GMod.username & "',vou_no,vou_type,vou_date,Acc_head_code,acc_head,dramt,cramt,pay_mode,Cheque_no," _
                & " Narration, group_name, sub_group_name, ch_issue_date, ch_date,VoucherTax, TaxPer, TaxType, WinOut " _
            ...
            If boolall = False Then
                ...
                If RadioButton1.Checked Then
                    If chkProduct.Checked = False Then
                        GMod.DataSetRet("select Narration, Vou_no, Vou_date,  vou_type, dramt, cramt, Cheque_no,balance  from repGeneralLedger1 where uname='" & GMod.username & "' and cmpid='" & GMod.Cmpid & "' and VoucherTax='" & cmbVoucherTax.Text & "' and TaxType='" & cmbTaxType.Text & "' and TaxPer='" & cmbPer.Text & "' order by Vou_date,cast(Vou_no as bigint)", "ledPrint")
                    Else
                        GMod.DataSetRet("select Narration, Vou_no, Vou_date,  vou_type, dramt, cramt, Cheque_no,balance  from repGeneralLedger1 where item_name='" & cmbPrduct.Text & "' and cmpid ='" & GMod.Cmpid & "' and uname='" & GMod.username & "' order by Vou_date,cast(Vou_no as bigint)", "ledPrint")
                    End If
                    ...
                    '----------------------------------------------------------------
                    r = Nothing
                    dgGridLeger.DataSource = GMod.ds.Tables("ledPrint")
    ...
    Private Sub rdOnscreen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdOnscreen.Click
        Try
            dgGridLeger.Visible = True
            CrViewerGenralLedger.Visible = False
    ...
    Private Sub rdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdPrint.Click
        ...
        Try
            dgGridLeger.Visible = False
            CrViewerGenralLedger.Visible = True
    ...
    Private Sub cmbTaxType_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbTaxType.SelectedIndexChanged
        'select per from dbo.TdsMater where cmp_id ='PHOE' and TdsType ='BROKERAGE'
    ...
    Private Sub cmbWiOs_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmbWiOs.SelectedIndexChanged
