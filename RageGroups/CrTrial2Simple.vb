...
Public Class CrTrial2Simple
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrTrial2Simple.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrTrial2Simple
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrTrial2Simple = New CrTrial2Simple()
        rpt.Site = Me.Site
        Return rpt
    End Function
