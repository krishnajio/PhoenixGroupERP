...
Public Class CrSupplyReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrSupplyReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrSupplyReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrSupplyReport1 = New CrSupplyReport1()
        rpt.Site = Me.Site
        Return rpt
    End Function
