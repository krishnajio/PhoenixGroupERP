Public Class frmPostToAccounts_Mutiple_Tr
    ...
    End Sub
    Dim i As Integer
    Dim sql, Narration, vou_date, narration1 As String
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            For i = 0 To dg.Rows.Count - 1
                If dg(0, i).Value = 1 Then
                    narration1 = narration1 & dg(4, i).Value
                    cr = cr + Val(dg(10, i).Value.ToString)
                    Label5.Text = cr.ToString
                End If
            Next
        Catch ex As Exception
