    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        If GMod.Cmpid = "PHHA" Or GMod.Cmpid = "WEPH" Then
            If cmbpaymenttype.Text = "OLD PAYMENT" Or cmbpaymenttype.Text = "ADVANCE PAYMENT" Then
                ...
                ElseIf rdTrans.Checked = True Then
                    TextBox1.Text = "BY  #TR NO. " + txtTRNo.Text + "# DT. " + dtTrDate.Text + "#  By Transfer #" & cmbpaymenttype.Text
            ...
            Else
                ...
                ElseIf rdTrans.Checked = True Then
                    TextBox1.Text = "BY  #TR NO. " + txtTRNo.Text + "# DT. " + dtTrDate.Text + "#  By Transfer #" & cmbpaymenttype.Text & "#" & dtHatchDate.Text
