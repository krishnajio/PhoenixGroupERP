        ...
        Try
            ...
            For i = 0 To dgBillNo.Rows.Count - 1
                If dgBillNo(0, i).Value = 1 Then
                    sql = "insert into " & GMod.VENTRY & " (Cmp_id, Uname, Entry_id, Vou_no, Vou_type, Vou_date, Acc_head_code, Acc_head, dramt, cramt, pay_mode, Cheque_no, Narration, Group_name, Sub_group_name, Ch_issue_date, Ch_date,exp_date) select Cmp_id, Uname, Entry_id, Vou_no, Vou_type, Vou_date, Acc_head_code, Acc_head, dramt, cramt, '" & GMod.username & "', Cheque_no, Narration, Group_name, Sub_group_name, Ch_issue_date, Ch_date,exp_date from dummy_VENTRY where vou_no='" & dgBillNo(2, i).Value & "' and vou_type='" & cmbvoutype.Text & "' and session ='" & GMod.Session & "' and Posted='N' and cmp_id ='" & GMod.Cmpid & "'"
