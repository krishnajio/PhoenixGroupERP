...
Public Class frmXlsToVoucher
        ...
        If MessageBox.Show("Are u Sure?", "Confirmation", MessageBoxButtons.YesNo) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                For i = 0 To dgvoucher.Rows.Count - 1
                    ...
                    sqlsave &= "'" & dgvoucher(7, i).Value & "',"
                    sqlsave &= "'" & dgvoucher(8, i).Value & "',"
                    sqlsave &= "'" & dgvoucher(9, i).Value & "',"
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        Try
            ...
            dgvoucher(7, i).Value = DtSet.Tables(0).Rows(i)(6).ToString.Trim
            dgvoucher(8, i).Value = DtSet.Tables(0).Rows(i)(7).ToString.Trim
            dgvoucher(9, i).Value = DtSet.Tables(0).Rows(i)(8).ToString.Trim
