...
Public Class CrPartyDueList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrPartyDueList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPartyDueList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPartyDueList = New CrPartyDueList()
        rpt.Site = Me.Site
        Return rpt
    End Function
