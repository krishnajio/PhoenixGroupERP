...
Public Class CrDebitNotePur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrDebitNotePur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDebitNotePur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDebitNotePur = New CrDebitNotePur()
        rpt.Site = Me.Site
        Return rpt
    End Function
