...
Public Class CrVprintSMTLD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrVprintSMTLD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrVprintSMTLD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrVprintSMTLD = New CrVprintSMTLD()
        rpt.Site = Me.Site
        Return rpt
    End Function
