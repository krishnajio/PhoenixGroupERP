...
Public Class CrGSTRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrGSTRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrGSTRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrGSTRegister = New CrGSTRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
