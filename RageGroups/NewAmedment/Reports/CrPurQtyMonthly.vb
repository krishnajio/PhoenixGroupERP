...
Public Class CrPurQtyMonthly
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrPurQtyMonthly.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPurQtyMonthly
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPurQtyMonthly = New CrPurQtyMonthly()
        rpt.Site = Me.Site
        Return rpt
    End Function
