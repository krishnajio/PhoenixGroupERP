...
Public Class CrPrintInvLaser
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrPrintInvLaser.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPrintInvLaser
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPrintInvLaser = New CrPrintInvLaser()
        rpt.Site = Me.Site
        Return rpt
    End Function
