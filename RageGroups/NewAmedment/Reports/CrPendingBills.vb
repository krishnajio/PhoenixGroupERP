...
Public Class CrPendingBills
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrPendingBills.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPendingBills
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPendingBills = New CrPendingBills()
        rpt.Site = Me.Site
        Return rpt
    End Function
