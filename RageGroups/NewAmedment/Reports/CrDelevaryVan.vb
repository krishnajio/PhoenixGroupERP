...
Public Class CrDelevaryVan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrDelevaryVan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDelevaryVan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDelevaryVan = New CrDelevaryVan()
        rpt.Site = Me.Site
        Return rpt
    End Function
