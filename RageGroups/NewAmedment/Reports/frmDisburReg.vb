Public Class frmDisburRegRep

    Dim sql As String
    Private Sub frmPurRepQtyMonth_Load(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub frmDisburReg_Load(sender As Object, e As EventArgs) Handles MyBase.Load
