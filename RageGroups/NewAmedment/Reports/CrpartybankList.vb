...
Public Class CrpartybankList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrpartybankList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpartybankList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpartybankList = New CrpartybankList()
        rpt.Site = Me.Site
        Return rpt
    End Function
