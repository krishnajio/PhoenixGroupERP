...
Public Class frmpoultrytmpinv
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        Try
            ...
            sql2 = " insert into salereg ( invno, invdate, hdate, code, cname, qty, free," _
                    & " invamt, neccamt,prd_name, Rate, area, uanme,vou_type,prdunit ) " _
                    & " select vou_no, BillDate,HatchDate,AccCode,h.account_head_name, " _
                    & " Qty,FreeQty,Amount,NeccAmount,ProductName,Rate,Station,'" & GMod.username & "',p.vou_type,PrdUnit from Printdata p " _
        ...
        GMod.DataSetRet("select invno, CONVERT(VARCHAR(11), invdate, 103) invdate ,CONVERT(VARCHAR(11), hdate, 103)  hdate, code, cname, prd_name, qty, free,  qty + free total ,rate, invamt, neccamt, prdunit  from salereg  where vou_type='" & voutype.Text & "' and uanme='" & GMod.username & "' order by id  ", "SaleRegGrid")
    ...
    Private Sub frmSalesRegister_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        GMod.DataSetRet("select * from vtype where cmp_id='" & GMod.Cmpid & "' and vtype like '%SALE%' and vtype not like '%JOURNAL%'", "vou_typesr")
    ...
    Private Sub rdpur_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdpur.CheckedChanged
        GMod.DataSetRet("select * from vtype where cmp_id='" & GMod.Cmpid & "' and vtype like '%PURCHASE%' and vtype not like '%JOURNAL%'", "vou_typesr")
        voutype.DataSource = GMod.ds.Tables("vou_typesr")
        voutype.DisplayMember = "vtype"
    ...
    Private Sub Button1_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        q = "select * from printdata where session ='" & GMod.Session & "' and cast(vou_no as bigint) between " & txtCrNoFrom.Text & " and " & txtCrNoTo.Text & " and vou_type='SALE JBP' order by freeqty desc"
        GMod.DataSetRet(q, "tmppulinv")


        Dim crsr As New CrPoultryTempInv
        crsr.SetDataSource(GMod.ds.Tables("tmppulinv"))
        'crsr.SetParameterValue("p1", GMod.Cmpname)
        'crsr.SetParameterValue("p2", "Invoice No. From " & txtCrNoFrom.Text & " To " & txtCrNoTo.Text)
        'crsr.SetParameterValue("p3", "Session " & GMod.Session)
        'crsr.SetParameterValue("p4", "User Name " & GMod.username)
