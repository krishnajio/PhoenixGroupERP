...
Public Class CrReceiptPrint
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrReceiptPrint.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrReceiptPrint
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrReceiptPrint = New CrReceiptPrint()
        rpt.Site = Me.Site
        Return rpt
    End Function
