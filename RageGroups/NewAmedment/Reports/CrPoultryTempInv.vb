...
Public Class CrPoultryTempInv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrPoultryTempInv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrPoultryTempInv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrPoultryTempInv = New CrPoultryTempInv()
        rpt.Site = Me.Site
        Return rpt
    End Function
