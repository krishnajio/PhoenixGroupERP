...
Public Class CrInvoice_Receipt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrInvoice_Receipt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrInvoice_Receipt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrInvoice_Receipt = New CrInvoice_Receipt()
        rpt.Site = Me.Site
        Return rpt
    End Function
