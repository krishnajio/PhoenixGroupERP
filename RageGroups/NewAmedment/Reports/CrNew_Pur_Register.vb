...
Public Class CrNew_Pur_Register
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrNew_Pur_Register.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrNew_Pur_Register
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrNew_Pur_Register = New CrNew_Pur_Register()
        rpt.Site = Me.Site
        Return rpt
    End Function
