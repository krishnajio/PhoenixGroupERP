...
Public Class CrDaily_MonthlyExp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CrDaily_MonthlyExp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrDaily_MonthlyExp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrDaily_MonthlyExp = New CrDaily_MonthlyExp()
        rpt.Site = Me.Site
        Return rpt
    End Function
