...
Public Class CryOtherSaleReg
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Phoenix_GroupERP.CryOtherSaleReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryOtherSaleReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryOtherSaleReg = New CryOtherSaleReg()
        rpt.Site = Me.Site
        Return rpt
    End Function
