...
Public Class frmBookOther
    ...
    Private Sub frmBook_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        listgrp.Items.Clear()
        GMod.DataSetRet("select vtype from Vtype where cmp_id='" & GMod.Cmpid & "' and vtype<>'OPEN' and session ='" & GMod.Session & "' and Vou_no_seq not in ('99') order by vtype", "grp")
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        Try
            ...
            sqldaybook = " select Acc_code, Acc_name, Narration, d.Vtype, Vouno, dramt, cramt, [Cheque No], " _
                         ...
                         & " left join vtype v  on d.vtype=v.vtype  and d.cmpid=v.Cmp_id where ( uname='" & GMod.username & "' and v.cmp_id='" & GMod.Cmpid & "' and v.session ='" & GMod.Session & "') or (v.vtype='OPEN' and v.session='" & GMod.Session & "')   order by id"
