Public Class frmInvPrint
    ...
    Private Sub btnshow_Click(sender As Object, e As EventArgs) Handles btnshow.Click
        ...
        Else
            If voutype.Text = "SALE BR(GST)" Or voutype.Text = "SALE CR(GST)" Then
                sql = "select Vou_type, cast(vou_no as bigint) Vou_no, AccCode, AccName, Station, ProductName, Qty, Rate, Amount,tcs_per as  DiscountRate,tcs_amt as  DiscountAmount  , NeccRate, NeccAmount, FreePer, FreeQty, HatchDate, BillNo, BillDate, Session, type, PrdUnit, Mortality, a.account_type as authr from PrintData p," & GMod.ACC_HEAD & " a where  a.account_code = p.acccode and cast(vou_no as bigint)  between '" & txtCrNoFrom.Text & "' and '" & txtCrNoTo.Text & "' and p.cmp_id ='" & GMod.Cmpid & "' and session ='" & GMod.Session & "' and vou_type ='" & voutype.Text & "' and type ='P' and left(acccode,2)='" & txtAreacode.Text & "' order by cast(vou_no as bigint)"
            Else
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        Else
            If voutype.Text = "SALE BR(GST)" Or voutype.Text = "SALE CR(GST)" Then
                sql = "select Vou_type, cast(vou_no as bigint) Vou_no, AccCode, AccName, Station, ProductName, Qty, Rate, Amount,tcs_per as  DiscountRate,tcs_amt as  DiscountAmount , NeccRate, NeccAmount, FreePer, FreeQty, HatchDate, BillNo, BillDate, Session, type, PrdUnit, Mortality, a.account_type as authr from PrintData p," & GMod.ACC_HEAD & " a where  a.account_code = p.acccode and Hatchdate  between '" & dtHatchdate.Value.ToShortDateString & "' and '" & dtphachdateTo.Value.ToShortDateString & "' and p.cmp_id ='" & GMod.Cmpid & "' and session ='" & GMod.Session & "' and vou_type ='" & voutype.Text & "' and type ='P'  and  p.acccode='" & txtCustCode.Text & "'  order by cast(vou_no as bigint)"
            Else
                sql = "select Vou_type, cast(vou_no as bigint) Vou_no, AccCode, AccName, Station, ProductName, Qty, Rate, Amount, tcs_per as  DiscountRate,tcs_amt as  DiscountAmount, NeccRate, NeccAmount, FreePer, FreeQty, HatchDate, BillNo, BillDate, Session, type, PrdUnit, Mortality, a.account_type as authr from PrintData p," & GMod.ACC_HEAD & " a where  a.account_code = p.acccode and a.account_code = p.acccode and Hatchdate  between '" & dtHatchdate.Value.ToShortDateString & "' and '" & dtphachdateTo.Value.ToShortDateString & "' and p.cmp_id ='" & GMod.Cmpid & "' and session ='" & GMod.Session & "' and vou_type ='" & voutype.Text & "' and type ='P' AND PRDUNIT ='" & ComboBox1.Text & "'  and  p.acccode='" & txtCustCode.Text & "'  order by cast(vou_no as bigint)"
