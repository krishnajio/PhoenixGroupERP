Public Class frmInvPrint
    ...
    Private Sub btnshow_Click(sender As Object, e As EventArgs) Handles btnshow.Click
        ...
        If GMod.Cmpid = "PHOE" Then
            sql = "select Vou_type, cast(vou_no as bigint) Vou_no, AccCode, AccName, Station, ProductName, Qty, Rate, Amount, tcs_per as  DiscountRate, tcs_amt as DiscountAmount,  tds_per as  NeccRate, tds_amt as  NeccAmount, FreePer, FreeQty, HatchDate, BillNo, BillDate, Session, type, PrdUnit, Mortality, a.account_type as authr from PrintData p," & GMod.ACC_HEAD & " a where  a.account_code = p.acccode and cast(vou_no as bigint)  between '" & txtCrNoFrom.Text & "' and '" & txtCrNoTo.Text & "' and p.cmp_id ='" & GMod.Cmpid & "' and session ='" & GMod.Session & "' and vou_type ='" & voutype.Text & "' and type ='P'  order by cast(vou_no as bigint)"
        Else
