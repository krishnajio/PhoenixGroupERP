...
repeatprod:
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        q = " Station, ProductName, OutQty, Rate,  Amount, OutQtyNos, BillNo, BillDate, InQty, InQtyNos, Session,mrktrate, Prdunit, Packing, Insurance, Discount, CrHead, cgstp, cgsta, sgstp, sgsta, igstp, igsta, "
