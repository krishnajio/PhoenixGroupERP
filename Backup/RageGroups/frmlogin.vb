...
Public Class frmlogin
    ...
    Private Sub frmlogin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        createBatchFile()
        Try
            If System.IO.File.Exists("Config1617.txt") Then
                Dim fs As New FileStream("Config1617.txt", FileMode.Open, FileAccess.Read)
                ...
                GMod.SqlConn.Open()
                'End If
            ElseIf System.IO.File.Exists("c:\Config1617.txt") Then
                Dim fs1 As New FileStream("c:\Config1617.txt", FileMode.Open, FileAccess.Read)
    ...
    Private Sub btnlogin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnlogin.Click
        ...
        Try
            ...
            sqllogin = "select role,dept,staff from Usertab1 where uname='" & txtuname.Text & "' and cast(Pwd as varchar(50)) = '" & txtpwd.Text & "'"
...
'
    ...
    Private Sub CreateTables() 'Creating Tables Only ADMIN right
        ...
        If GMod.ds.Tables("tableaccount").Rows.Count = 0 Then
            createtablesql = "CREATE TABLE " & tablename & "(" _
                                ...
                                & "[Acc_head_code] [varchar](8)  NOT NULL DEFAULT ('-') ," _
                                & "[Acc_head] [varchar](30)  NOT NULL DEFAULT ('-') ," _
        ...
        If GMod.ds.Tables("tableaccount").Rows.Count = 0 Then
            createtablesql = "CREATE TABLE " & tablename & "(" _
                                            ...
                                            & "[Bank_acc_head] [varchar](30)  NOT NULL DEFAULT ('-')," _
        ...
        If GMod.ds.Tables("tableaccount").Rows.Count = 0 Then
            createtablesql = "CREATE TABLE " & tablename & "(" _
                                 ...
                                 & "[Cheque_no] [varchar](15)  NOT NULL DEFAULT ('-') ," _
                                 & "[BankAcc_code] [Varchar](10)  NOT NULL DEFAULT ('-')," _
                                 ...
                                 & "[party_name] [varchar](30) NOT NULL  DEFAULT ('-')," _
    ...
    Private Sub txtpwd_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtpwd.Enter
