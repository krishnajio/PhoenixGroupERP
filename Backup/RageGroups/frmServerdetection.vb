...
Public Class frmServerdetection
    ...
    Private Sub btncontinue_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btncontinue.Click
        Try
            'If bool = True Then
            Dim ConnStr As String = "Data Source= " & cmbserver.Text & ";Initial Catalog=PhxGroup;User ID=" & txtusername.Text & ";Password=" & txtpwd1.Text & ";Connect Timeout=3000;"
            'MsgBox(ConnStr)
            Dim tmpstr As String
            tmpstr = EncryptionStr(ConnStr, True)
            Dim fs As New FileStream("Config1617.txt", FileMode.Create)
            ...
            frmlogin.Show()
            Me.Hide()
            File.Copy("Config1617.txt", "C:\Config1617.txt")
            'End If
