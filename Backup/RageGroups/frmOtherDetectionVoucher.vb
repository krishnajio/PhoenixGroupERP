...
Public Class frmOtherDetectionVoucherDr
    Dim sql As String, sqlname As String
    Dim row As Integer = 0, j As Integer
    Dim ConStrSal As String = "Data Source=phxserver;Initial Catalog=PhoenixSalary;User ID=sa;Password=p#hoenix@g"
    ...
    Private Sub frmSalaryBankDr_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sql = " select * from " & GMod.ACC_HEAD & " where cmp_id='" & GMod.Cmpid & "' AND group_name in ('EXPENSES')"
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        Try
            ...
            If ComboBox1.Text = "CASH" Then
                sql = "select empid,name,department,od1 tt from  salacctransfer " _
                & " where orgid='" & cmbDept.Text & "' and salmonth='" & dtSalaryDate.Text & "' and od1>0 AND paymode='" & ComboBox1.Text & "' order by department,empid"
            Else
                sql = "select empid,name,department,od1 tt from  View_1 " _
                & " where orgid='" & cmbDept.Text & "' and salmonth='" & dtSalaryDate.Text & "' and od1>0 AND paymode='" & ComboBox1.Text & "'  and left(accountno,3)='" & ComboBox2.Text & "'  order by department,empid"
            End If
