Public Class frmTdsMaster
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        If txtTdsType.Text = "" Then
            MsgBox("TDS Type can't be blank")
            txtTdsType.Focus()
            Exit Sub
        End If

        If txtTdsper.Text = "" Then
            MsgBox("TDS Percentage can't be blank")
            txtTdsper.Focus()
            Exit Sub
        End If
        ...
        sql = "insert into TdsMater(TdsType, Per, Acc_Code,cmp_id) values ("
    ...
    Private Sub btn_modify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_modify.Click
        If btn_modify.Text = "&Update" Then
            ...
            sql = "Update TdsMater "
            sql &= " set TdsType='" & txtTdsType.Text.ToUpper & "',"
