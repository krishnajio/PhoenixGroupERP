...
Public Class frmSalaryTransferHatch
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        Dim ConStrSal As String = "Data Source=192.168.0.130;Initial Catalog=PhoenixSalUNO;User ID=sa;Password=ph@hoenix#g"
        Dim sql, orgid, sqlname As String
        Dim i, j, row As Integer
        Dim da As New SqlDataAdapter
        Dim a, b, c, d, f, t, p As String
        If GMod.Cmpid = "PHOE" Then
            orgid = "Phoenix Poultry"
        ...
        For i = 0 To dsSal.Tables("Department").Rows.Count - 1
            ...
            If cmbPaymode.Text = "BANK" Then
                sql = "select sum(amtpay+hra+cca+oa2+oa1+da) from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='BANK'"
            ElseIf cmbPaymode.Text = "CASH" Then
                sql = "select sum(amtpay+hra+cca+oa2+oa1+da) from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='CASH'"
            End If
            da = New SqlDataAdapter(sql, ConStrSal)
            ...
            Try
                ...
                If cmbPaymode.Text = "BANK" Then
                    sql = "select empid,name,department,(amtpay+hra+cca+oa2+oa1+da) tt from  salacctransfer " _
            ...
            If cmbPaymode.Text = "BANK" Then
                sql = "select sum(amt833+amt367)  from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='BANK'"
            ElseIf cmbPaymode.Text = "CASH" Then
                sql = "select sum(amt833+amt367)  from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='CASH'"
            ...
            row = row + 1
            If cmbPaymode.Text = "BANK" Then
                sql = "select isnull(sum(groupinsded),0)  from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and orgid='" & orgid & "' and groupinsded>0 and paymode='BANK'"
            Else
                sql = "select isnull(sum(groupinsded),0)  from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and orgid='" & orgid & "' and groupinsded>0 and paymode='CASH'"
            End If
        ...
        If GMod.Cmpid = "PHOE" Then
            Try
                '''''FOR ESI
                If cmbPaymode.Text = "BANK" Then
                    sql = "select sum(secudep) from  salacctransfer where  salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='BANK'"
                Else
                    sql = "select sum(secudep) from  salacctransfer where  salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='CASH'"
                ...
                If cmbPaymode.Text = "BANK" Then
                    sql = "select empid,secudep from salacctransfer where secudep>0 and orgid='" & orgid & "' and salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and paymode='BANK'"
                Else
                    sql = "select empid,secudep from salacctransfer where secudep>0 and orgid='" & orgid & "' and salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and paymode='CASH'"
        ...
        Try
            ...
            'row = row + 1
            If cmbPaymode.Text = "BANK" Then
                sql = "select sum(it) from  salacctransfer where  salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='BANK'"
            Else
                sql = "select sum(it) from  salacctransfer where  salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='CASH'"
            End If
            da = New SqlDataAdapter(sql, ConStrSal)
            ...
            If Val(dsSal.Tables("totalit").Rows(0)(0)) > 0 Then
                ...
                If cmbPaymode.Text = "BANK" Then
                    sql = "select empid,it from salacctransfer where it>0 and orgid='" & orgid & "' and  salmonth='" & dtSalaryDate.Text & "' and paymode='BANK'"
                Else
                    sql = "select empid,it from salacctransfer where it>0 and orgid='" & orgid & "' and  salmonth='" & dtSalaryDate.Text & "' and paymode='CASH'"
        ...
        Try
            ...
            'row = row + 1
            If cmbPaymode.Text = "BANK" Then
                sql = "select sum(proftax) from  salacctransfer where  salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and orgid='" & orgid & "' and paymode='BANK'"
            Else
                sql = "select sum(proftax) from  salacctransfer where  salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and orgid='" & orgid & "' and paymode='CASH'"
            ...
            If Val(dsSal.Tables("totalptax").Rows(0)(0)) > 0 Then
                ...
                If cmbPaymode.Text = "BANK" Then
                    sql = "select empid,proftax from salacctransfer where proftax>0 and orgid='" & orgid & "' and  salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and paymode='BANK'"
                Else
                    sql = "select empid,proftax from salacctransfer where proftax>0 and orgid='" & orgid & "' and  salmonth='" & dtSalaryDate.Value.ToShortDateString & "' and paymode='CASH'"
                End If
                da = New SqlDataAdapter(sql, ConStrSal)
