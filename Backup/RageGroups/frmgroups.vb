...
Public Class frmgroups
    ...
    Private Sub btnsave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnsave.Click
        ...
        Dim sql As String
        sql = "select * from Groups where cmp_id='" & GMod.Cmpid & "' and suffix='" & txtgroupsfx.Text & "' "
        ...
        Sqlsavestr = "Insert into Groups(Group_name,Suffix,BS_PL,Cmp_id,Dr_Cr, EffectsIN) values ("
    ...
    Public Sub fillgrid()
        ...
        sqlselectall = "select Group_name,Suffix, BS_PL,Dr_Cr, EffectsIN  from Groups where Cmp_id='" & GMod.Cmpid & "'"
    ...
    Private Sub btndelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndelete.Click
        ...
        Else
            ...
            End If
            If MessageBox.Show("Are u sure?", "Information", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
                GMod.DataSetRet("select * from sub_group where group_name='" & txtgroupname.Text & "'", "ser")
    ...
    Private Sub txtgroupname_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtgroupname.Leave
        If txtgroupname.Text.Length > 0 Then
            ...
            gprefix = txtgroupname.Text.Substring(0, 2).ToUpper
        End If
    End Sub
