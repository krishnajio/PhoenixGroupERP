...
Public Class frmSaleChicken
    ...
    Sub nxtvno()
        Dim sql As String
        Try
            sql = "SELECT isnull(max(cast(vou_no as numeric(18,0))),0) + 1 FROM " & GMod.VENTRY & " where vou_type='SALE'"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        sqlsave = "delete from " & GMod.VENTRY & " where vou_no='" & txtVoucherNo.Text & "' and vou_type='SALE'"
        Dim cmd12 As New SqlCommand(sqlsave, GMod.SqlConn, sqltrans)
        cmd12.ExecuteNonQuery()


        sqlsave = "delete from InvPhxChicken where vou_no='" & txtVoucherNo.Text & "' and vou_type='SALE' and Session='" & GMod.Session & "'"
        Dim cmd13 As New SqlCommand(sqlsave, GMod.SqlConn, sqltrans)
        cmd13.ExecuteNonQuery()


        narrinv = "INV NO " & txtInvnoNo.Text & " DT." & dtInvVate.Text & " BATCH NO " & lblbatchno.Text & " "
...
x1:
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        If btnSave.Enabled = True Then
            ...
            If vou_no <> "" Then
                ...
                '    Exit Sub
                'End If
                sqlinv = "select * from InvPhxChicken where Vou_no='" & vou_no & "' and Vou_type='SALE' and Session='" & GMod.Session & "'"
                ...
                sql = "select * from " & GMod.VENTRY & " where Vou_no='" & vou_no & "' and group_name='COMMISSION' and vou_type='SALE' "
                ...
                sql = "select * from " & GMod.VENTRY & " where Vou_no='" & vou_no & "' and group_name in('FREIGHT','EXPENSES','FRIEGHT') and vou_type='SALE'"
    ...
    Public Sub heads()
        Dim sql As String
        sql = " select account_head_name,account_code,group_name from " & GMod.ACC_HEAD & " where cmp_id='" & GMod.Cmpid & "' and group_name in('CUSTOMER','SHOP','INTERNAL PARTY','PARTY') " ' and left(account_code,2) in('" & cmbAreaCode.Text & "','**')"
        ...
        sqlsale = "select * from " & GMod.ACC_HEAD & " where group_name like '%SALE%'  or group_name like '%FREIGHT%'"
        ...
        sqlcomm = "select * from " & GMod.ACC_HEAD & " where group_name like '%COMM%' or group_name like '%sale%'"
