    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        For i = 0 To dsSal.Tables("Department").Rows.Count - 1
            ...
            If cmbPaymode.Text = "BANK" Then
                sql = "select sum(amtpay+hra+cca+oa2+oa1+da) from  salacctransfer where department='" & dsSal.Tables("Department").Rows(i)("Department").ToString & "' and salmonth='" & dtSalaryDate.Text & "' and orgid='" & orgid & "' and paymode='BANK'" ' and is_ho_emp = '" & RdHO.Checked.ToString & "'"
