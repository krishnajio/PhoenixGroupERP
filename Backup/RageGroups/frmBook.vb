...
Public Class frmBook
    ...
    Private Sub btnshow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnshow.Click
        ...
        Try
            ...
            Dim sqldaybefore As String = "select isnull(sum(dramt),0),isnull(sum(cramt),0) " _
                                         & "from " & GMod.VENTRY & " where vou_date < '" & dtfrom.Value.ToShortDateString() & "' and Pay_mode<>'-' and vou_type<>'BANKREC' and vou_type in(" & lst & ")"
    ...
    Private Sub btndosprint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btndosprint.Click
        If chkdaybook = True Then
            MsgBox("Un checked voucher exixts for the day, please authorise first", MsgBoxStyle.Critical)
            Exit Sub
        End If
