Public Class frmNewPurchaseRegister
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Else
            sql = "select pd.*,ach.account_head_name,ach.address,ach.remark2 from Purchase_Data pd"
            sql &= " left join " & GMod.ACC_HEAD & " ach on pd.party_code= ach.account_code where pd.session='" & GMod.Session & "' and vou_type='" & voutype.Text & "' and authr<>'-' and cform=1  and for_where='" & cmbprdunit.Text & "'"
