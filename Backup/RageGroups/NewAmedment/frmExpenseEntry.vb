...
Public Class frmExpenseEntry
    ...
    Private Sub detadd_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles detadd.Click
        ...
        Dim obj() As Object = {dtpHatchDt.Value.ToShortDateString, txtarea.Text, txtNoChicks.Text, txtDeisel.Text, txtToll.Text, txtda.Text, txtLA.Text, txtOther.Text, txtTotalkm.Text, txtTotalDiedelltrs.Text, txtDriverName.Text, txtAcName.Text, lblcode.Text}
        If i <> -1 Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For i = 0 To dgexpenses.Rows.Count - 1
            ...
            " da, other, driver_name, la_ul,uname,ltrs,totalkms) values ("
    ...
    Private Sub txtTotalDiedelltrs_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtTotalDiedelltrs.KeyUp
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub

    Private Sub txtTotalDiedelltrs_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtTotalDiedelltrs.TextChanged
