...
Public Class frmBTVoucher
    ...
    Private Sub btnOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnOk.Click
        If Val(txtDramt.Text) + Val(txtCrmat.Text) = 0 Then
            ...
            Exit Sub
        End If
        Dim obj() As Object = {cmbAcHead.Text, cmbcode.Text, txtDramt.Text, txtCrmat.Text, ComboBox1.Text, ComboBox2.Text, txtNarration.Text, txtChqNo.Text, dthdate.Value.ToShortDateString}
        If i <> -1 Then
    ...
    Private Sub frmPayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If "$" & GMod.usrname <> GMod.username Then
            If GMod.Dept = 1 Then
                sql = "select vtype from Vtype where cmp_id='" & GMod.Cmpid & "' and vou_no_seq='" & GMod.Dept & "' and vprefix='JP'"
            ...
            'dthdate.Value = CDate("1/1/2000")
        Else
            sql = "select vtype from Vtype where cmp_id='" & GMod.Cmpid & "' and (vprefix like '%J%'  or vprefix like '%bt%'  or vprefix like '%F%' or vprefix like '%P%') and Vtype not in ('BANK','CR VOUCHER','CR VOUCHER-TR','CASH','OPEN') and VTYPE NOT LIKE '%OTHER SALE%' and VTYPE NOT LIKE '%CHICKS%' "
            GMod.DataSetRet(sql, "CRVT")
            cmbvoutype.DataSource = GMod.ds.Tables("CRVT")
            cmbvoutype.DisplayMember = "vtype"
        End If
    ...
    Private Sub dgPayment_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgPayment.CellDoubleClick
        Try
            ...
            dthdate.Value = CDate(dgPayment(8, i).Value.ToString)
        ...
        If MessageBox.Show("Are U sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                For j = 0 To dgPayment.Rows.Count - 1
                    ...
                    sql &= "'" & CDate(dgPayment(8, j).Value.ToString) & "',"
                ...
                For i = 0 To DataGridView1.RowCount - 1
                    ...
                    sqlsavecr &= "'" & DataGridView1(4, i).Value & "',"
                ...
                Next
                Dim cmd2 As New SqlCommand("delete from tmpAging where acc_code='" & cmbcode.Text & "' and vou_type='" & cmbvoutype.Text & "' and cmp_id='" & GMod.Cmpid & "'", GMod.SqlConn, trans)
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        If btnSave.Enabled Then
            ...
            dtvdate.MinDate = CDate(GMod.ds.Tables("modifypay").Rows(0)("Vou_date"))
    ...
    Private Sub dtpexpensedate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dtpexpensedate.KeyDown
        ...
        End If
    End Sub
    Private Sub dtpdate_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dthdate.KeyDown
    ...
    Private Sub dg_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dg.KeyUp
        ...
        End If
    End Sub
    Private Sub dtpdate_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles dthdate.KeyUp
        If e.KeyCode = Keys.Enter Then
            SendKeys.Send("{TAB}")
        End If
    End Sub
