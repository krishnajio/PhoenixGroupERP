...
Public Class frmPaymentandChqprint
        ...
        If MessageBox.Show("Are U sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                For j = 0 To dgPayment.Rows.Count - 1
                    ...
                    " Sub_group_name, Ch_issue_date, Ch_date,session) values ("
                    sql &= "'" & GMod.Cmpid & "',"
                    sql &= "'" & GMod.username & "',"
                    sql &= "'" & j & "',"
                    sql &= "'" & txtvou_no.Text & "',"
                ...
                For rcount = 0 To dgBillNo.Rows.Count - 1
                    If dgBillNo(0, rcount).Value = True Then
                        sql = "insert into bank_payment(party_code, bill_no, bill_date, amt, session, cmp_id,vou_type,vou_no) values( "
                        sql &= "'" & acc_code & "',"
    ...
    Private Sub cmbcode_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbcode.Leave
        ...
        sql = "select q.account_code,q.acname," _
                    ...
                    & " isnull(opening_cr,0) ocr from " & GMod.ACC_HEAD & " where account_code='" & cmbcode.Text.Trim & "'  ) q " _
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        For rcount = 0 To dgBillNo.Rows.Count - 1
            If dgBillNo(0, rcount).Value = 1 Then
                amt = amt + Val(dgBillNo(3, rcount).Value)
                amtchk = amt
            End If
        Next
        txtDramt.Text = amt
