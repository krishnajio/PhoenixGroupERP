...
Public Class frmExpenses
    ...
    Private Sub frmPayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sql = "select vtype from Vtype where cmp_id='" & GMod.Cmpid & "' and Vtype like '%EXPS%' and vou_no_seq=2 or Vtype like '%EXPENSES%'"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If MessageBox.Show("Are U sure?", "Confirmation", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) = Windows.Forms.DialogResult.Yes Then
            ...
            Try
                ...
                sql = "insert into Expenses_det(vou_type, vou_no, acc_code, acc_name, hatch_date, no_of_chicks, area, deisel, toll_tax, da, other, driver_name, la_ul, uname,session,ltrs,totalkms) "
                sql &= " select vou_type, " & txtvou_no.Text & ", acc_code, acc_name, hatch_date, no_of_chicks, area, deisel, toll_tax, da, other, driver_name, la_ul, uname,'" & GMod.Session & "',ltrs,totalkms from Expenses_tmp where uname ='" & GMod.username & "'"
    ...
    Private Sub btnModify_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnModify.Click
        ...
        If btnSave.Enabled Then
            ...
            Try
                ...
                sql = "select convert(varchar, hatch_date, 3) hatch_date,area,no_of_chicks,deisel,toll_tax,da,la_ul,other,totalkms,ltrs,driver_name,acc_name,acc_code from Expenses_det where vou_type='" & GMod.vou_type & "' and vou_no='" & GMod.vou_no & "' and session ='" & GMod.Session & "'"
    ...
    Private Sub dtvdate_ValueChanged_2(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dtvdate.ValueChanged
