    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        ...
        Try
            If ComboBox1.Text = "CASH" Then
                ...
                Else
                    sql = "select empid,name,department,oa1 tt from  salacctransfer " _
                    & " where orgid='" & cmbDept.Text & "' and salmonth='" & dtSalaryDate.Text & "' and oa1>0 AND paymode='" & ComboBox1.Text & "'  order by department,empid"
                End If
            Else
                If ComboBox1.Text = "CASH" Then
                    sql = "select empid,name,department,oa1 tt from  salacctransfer " _
                ...
                Else
                    ...
                    sql = "select empid,name,department,oa1 tt from  View_1 " _
                   & " where orgid='" & cmbDept.Text & "' and salmonth='" & dtSalaryDate.Text & "' and oa1>0 AND paymode='" & ComboBox1.Text & "'  and left(accountno,3)='" & ComboBox2.Text & "' order by department,empid"
